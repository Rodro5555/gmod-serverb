...
SWEP.PrintName = "Kit Medico"
SWEP.Author = "joder"
SWEP.Purpose = "Cura a las personas con click izquierdo y curate a ti mismo con click derecho"
local delay = 2
SWEP.Slot = 4
SWEP.SlotPos = 3
SWEP.Category  = "Other"
...
SWEP.HealAmountSecondary = 20 -- Maximum heal amount per use
...
function SWEP:SecondaryAttack()
	...
	local need = self.HealAmountSecondary
	if ( IsValid( ent ) ) then need = math.min( ent:GetMaxHealth() - ent:Health(), self.HealAmountSecondary ) end
