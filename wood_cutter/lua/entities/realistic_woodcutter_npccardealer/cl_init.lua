...
function ENT:Draw()
	...
	if LocalPlayer():GetPos():Distance(self:GetPos()) < 500 then
		...
		if (self:GetDTInt(1) == 0) then
			draw.SimpleTextOutlined(Realistic_Woodcutter.NameCarDealer, "rps_font_11", 0, -3050, Realistic_Woodcutter.Colors["white"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, Realistic_Woodcutter.Colors["overhead_color"]);		
		end
		cam.End3D2D() // ecbaa12e92fc4497d5a9b14f13d31d30f3b996f167d822a11af45f8e0eee7def
	end 
end 