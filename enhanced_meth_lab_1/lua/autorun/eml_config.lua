...
EML_SpecialPot_DestroyEmpty = false;
...
-- Meth value modifier. (each lbs)
EML_Meth_ValueModifier = 375;
-- Meth addicted person (I don't like NPCs at all).
EML_Meth_UseSalesman = true;

EML_Meth_Police_Cut = 0.6
...
EML_Meth_Salesman_GotMeth = {
    ...
    "¡Oh Dios mío!",
    "¡Eres genial! ¡Trae más!"
	};	
-- Salesman phrases if player don't have meth.	
EML_Meth_Salesman_GotMeth_Sound = {
    "vo/npc/vortigaunt/vortigese9.wav",
    "vo/npc/vortigaunt/vortigese9.wav",
    "vo/npc/vortigaunt/vortigese9.wav",
    "vo/npc/vortigaunt/vortigese9.wav",
    "vo/npc/vortigaunt/vortigese9.wav",
...
EML_Jar_CorrectShake = 2;
-- Progress on incorrect shaking.
