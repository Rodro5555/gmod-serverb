	...
	function simfphys.SpawnVehicle( Player, Pos, Ang, Model, Class, VName, VTable, bNoOwner )
		...
		if VTable.Members then
			...
			if not simfphys.WeaponSystemRegister then
				...
				if (simfphys.WeaponSystemRegister and not simfphys.WeaponSystemRegister()) or simfphys.RegisterEquipment then
					...
					print("[SIMFPHYS ARMED]: simfphys.FireBullet")
					print("[SIMFPHYS ARMED]: simfphys.FirePhysBullet")
					print("[SIMFPHYS ARMED]: simfphys.xhairRegister")
					print("[SIMFPHYS ARMED]: simfphys.CameraRegister")
					print("[SIMFPHYS ARMED]: simfphys.WeaponSystemRegister")
					...
					simfphys.FireBullet = function( data ) simfphys.FireBullet( data ) end
					simfphys.FirePhysBullet = function( data ) simfphys.FirePhysBullet( data ) end
					simfphys.xhairRegister = function( ent, data ) simfphys.xhairRegister( ent, data ) end
					simfphys.CameraRegister = 
					...
					simfphys.WeaponSystemRegister = function( vehicle ) simfphys.WeaponSystemRegister( vehicle ) return true end
				end
			end
