...
TCF.Config.Lang["I don't want to speak with you in your current position, go away!"] = {
	...
	["es"] = "No quiero hablar contigo en tu trabajo actual, vete!",
...
TCF.Config.Lang["This box is not yours, you can't sell it!"] = {
	["en"] = "This box is not yours, you can't sell it!",
	["fr"] = "Cette boîte ne vous appartient pas, vous ne pouvez pas la vendre!",
	["da"] = "Denne boks er ikke din, du kan ikke sælge den!",
	["de"] = "Diese Box gehört nicht dir, du kannst sie nicht verkaufen!",
	["pl"] = "To pudełko nie należy do ciebie, nie możesz go sprzedać!",
	["ru"] = "Эта коробка не твоя, ты не можешь её продать!",
	["es"] = "!Esta caja no es tuya, no puedes venderla!",
	["cn"] = "这个箱子不是你的,你不能卖!",
	["tr"] = "Bu kutu senin degil, satabilirsin!",
}
TCF.Config.Lang["You don't have any cocaine to sell."] = {
	["en"] = "You don't have any cocaine to sell.",
	["fr"] = "Vous n'avez pas de cocaïne à vendre.",
	["da"] = "Du har ikke noget kokain at sælge.",
	["de"] = "Du hast kein Kokain zum Verkauf.",
	["pl"] = "Nie masz żadnej kokainy do sprzedania.",
	["ru"] = "У тебя нет кокаина для продажи.",
	["es"] = "No tienes cocaína para vender.",
	["cn"] = "你没有可卡因卖.",
	["tr"] = "Satacagin kokoinin yok.",
}
