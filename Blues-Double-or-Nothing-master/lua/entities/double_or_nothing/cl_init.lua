...
jackpotFrames[2] = function(ScrW, ScrH)
	draw.SimpleText("No te preocupes", "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5, Color(60,60,60,255), 1, 0)
	draw.SimpleText("No te preocupes", "BDON_MEDIAM", ScrW/2, ScrH / 2, Color(255,255,255,255), 1, 0)
end

--This isnt a glitch
jackpotFrames[3] = function(ScrW, ScrH)
	draw.SimpleText("Esto no es un glitch", "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5, Color(60,60,60,255), 1, 0)
	draw.SimpleText("Esto no es un glitch", "BDON_MEDIAM", ScrW/2, ScrH / 2, Color(255,255,255,255), 1, 0)
end

--I'v got something to tell you
jackpotFrames[4] = function(ScrW, ScrH)
	draw.SimpleText("Tengo algo", "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5, Color(60,60,60,255), 1, 0)
	draw.SimpleText("Tengo algo", "BDON_MEDIAM", ScrW/2, ScrH / 2, Color(255,255,255,255), 1, 0)

	draw.SimpleText("que decirte", "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5 + 75, Color(60,60,60,255), 1, 0)
	draw.SimpleText("que decirte", "BDON_MEDIAM", ScrW/2, ScrH / 2 + 75, Color(255,255,255,255), 1, 0)
end

--Something important
jackpotFrames[5] = function(ScrW, ScrH, ent)
	draw.SimpleText("Algo importante", "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5, Color(60,60,60,255), 1, 0)
	draw.SimpleText("Algo importante", "BDON_MEDIAM", ScrW/2, ScrH / 2, Color(255,255,255,255), 1, 0)
end

--Congratulations player
jackpotFrames[6] = function(ScrW, ScrH, ent)
	draw.SimpleText("Felicidades", "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5, Color(60,60,60,255), 1, 0)
	draw.SimpleText("Felicidades", "BDON_MEDIAM", ScrW/2, ScrH / 2, Color(255,255,255,255), 1, 0)
...
jackpotFrames[7] = function(ScrW, ScrH, ent)
	draw.SimpleText("Acabas de", "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5, Color(60,60,60,255), 1, 0)
	draw.SimpleText("Acabas de", "BDON_MEDIAM", ScrW/2, ScrH / 2, Color(255,255,255,255), 1, 0)

	draw.SimpleText("ganar el...", "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5 + 75, Color(60,60,60,255), 1, 0)
	draw.SimpleText("ganar el...", "BDON_MEDIAM", ScrW/2, ScrH / 2 + 75, Color(255,255,255,255), 1, 0)	
end
...
jackpotFrames[9] = function(ScrW, ScrH, ent)
	...
	draw.SimpleText("TU PREMIO", "BDON_LARGE", ScrW/2 + 5, 450 + 5 - 30, Color(60,60,60,255), 1, 0)
	draw.SimpleText("TU PREMIO", "BDON_LARGE", ScrW/2, 450 - 30, Color(255,255,255, 255), 1, 0)
...
function ENT:DrawScreen(ScrW, ScrH)
	...
	if self:GetCashOutAmount() > 0 then
		...
		draw.SimpleText("¡GANASTE!", "BDON_LARGE", ScrW/2 + 5, 350 + 5 - 30, Color(60,60,60,255), 1, 0)
		draw.SimpleText("¡GANASTE!", "BDON_LARGE", ScrW/2, 350 - 30, Color(255,255,255,255), 1, 0)
		...
		local textToDisplay = "Usuario actual : "..self:GetUserName()
	...
	if self:GetGameStarted() == false then
		...
		draw.SimpleText("Alcanza X10 para el Jackpot!", "BDON_MEDIAM", ScrW/2 + 5, ScrH - 450 + 5, Color(60,60,60,255), 1, 0)
		draw.SimpleText("Alcanza X10 para el Jackpot!", "BDON_MEDIAM", ScrW/2, ScrH - 450, Color(255,255,255,255), 1, 0)
...
net.Receive("bdn:winninginfo", function()
	...
	chat.AddText(Color(255,255,255), "[BLUE'S SLOTS] Felicidades, acabas de ganar ", Color(255,0,255), "$"..comma_value(winAmount))
end)
...
net.Receive("bdn:jackpotinfo", function()
	...
	chat.AddText(Color(255,215,0), "[BLUE'S SLOTS] ", Color(255,0,255), ply:Name(), Color(255,215,0), " acaba de ganar ", Color(255,0,255), BDON_CONFIG.CurrenyPrefix..comma_value(amount), Color(255,215,0), " en ", Color(0,255,0), "Doble ", Color(255,255,255), "O ", Color(255,0,0), "Nada!")
end)
--Sound related stuff
