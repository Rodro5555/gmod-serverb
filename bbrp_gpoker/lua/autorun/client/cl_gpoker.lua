...
net.Receive("gpoker_derma_createGame", function()
    ...
    win:Center()
    win:SetTitle("Seleccione la configuración del juego")
    ...
    local gameOption = options:Add("Juego")
    local betOption = options:Add("Apuesta")
    ...
    gameSelectText:SetText("Tipo de juego")
    ...
    maxPlyText:SetText("Cantidad máxima de jugadores")
    ...
    betText:SetText("Tipo de apuesta")
    ...
    entryFee:SetText("Cuota de entrada")
    ...
    startValue:SetText("Valor inicial")
    ...
    placeholder:SetTooltip("Cuando la mesa está llena, cualquier jugador que intente unirse tomará el lugar del bot al azar.")
