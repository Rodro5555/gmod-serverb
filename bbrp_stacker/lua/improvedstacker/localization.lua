...
localify.Bind( "es-es", prefix.."language_es-es", "Spanish" )
...
-- Tool Settings
localify.Bind( "es-es", prefix.."name",                     "Stacker - Mejorado" )
localify.Bind( "es-es", prefix.."desc",                     "Apile fácilmente props duplicados en cualquier dirección" )
localify.Bind( "es-es", prefix.."left",                     "Crear una pila" )
localify.Bind( "es-es", prefix.."shift_left",               "Aumentar el tamaño de la pila" )
localify.Bind( "es-es", prefix.."right",                    "Crear un solo apoyo" )
localify.Bind( "es-es", prefix.."shift_right",              "Reducir el tamaño de la pila" )
localify.Bind( "es-es", prefix.."reload",                   "Cambiar la dirección de la pila" )
localify.Bind( "es-es", "Undone_stacker_improved",          "Undone stacked prop(s)" )
-- Errors
localify.Bind( "es-es", prefix.."error_blocked_by_server",  "El servidor le ha impedido cambiar esta variable de consola" )
localify.Bind( "es-es", prefix.."error_not_admin",          "Debe estar en el grupo de usuarios 'admin' para cambiar esta variable de consola" )
localify.Bind( "es-es", prefix.."error_invalid_argument",   "Debe introducir un valor de número válido" )
localify.Bind( "es-es", prefix.."error_max_per_stack",      "El máximo de props que se pueden apilar a la vez está limitado a" )
localify.Bind( "es-es", prefix.."error_too_quick",          "Está utilizando el stacker demasiado rápido" )
localify.Bind( "es-es", prefix.."error_max_per_player",     "Se alcanzó el límite de props del stacker" )
localify.Bind( "es-es", prefix.."error_not_in_world",       "Los props apilados deben generarse dentro del mundo." )
localify.Bind( "es-es", prefix.."error_max_constraints",    "No se pudo crear la restricción, lo más probable es que se quedara sin ranuras de entidad" )
-- Labels
localify.Bind( "es-es", prefix.."label_presets",            "Ajustes preestablecidos del stacker:" )
localify.Bind( "es-es", prefix.."label_relative",           "Pila relativa a:" )
localify.Bind( "es-es", prefix.."label_direction",          "Dirección de la pila:" )
localify.Bind( "es-es", prefix.."label_count",              "Tamaño de la pila" )
localify.Bind( "es-es", prefix.."label_reset_offsets",      "Restablecer compensaciones" )
localify.Bind( "es-es", prefix.."label_reset_angles",       "Restablecer ángulos" )
localify.Bind( "es-es", prefix.."label_show_settings",      "Haga clic para mostrar la configuración" )
localify.Bind( "es-es", prefix.."label_hide_settings",      "Haga clic para ocultar la configuración" )
localify.Bind( "es-es", prefix.."label_x",                  "X (-atrás, +frente)" )
localify.Bind( "es-es", prefix.."label_y",                  "Y (-izquierda, +derecha)" )
localify.Bind( "es-es", prefix.."label_z",                  "Z (-abajo, +arriba)" )
localify.Bind( "es-es", prefix.."label_pitch",              "Pitch (-abajo, +arriba)" )
localify.Bind( "es-es", prefix.."label_yaw",                "Yaw (-izquierda, +derecha)" )
localify.Bind( "es-es", prefix.."label_roll",               "Roll (-izquierda, +derecha)" )
localify.Bind( "es-es", prefix.."label_language",           "Idioma:" )
localify.Bind( "es-es", prefix.."label_credits",            "No" )
localify.Bind( "es-es", prefix.."label_max_per_stack",      "Tamaño de la pila" )
localify.Bind( "es-es", prefix.."label_max_per_player",     "Props por jugador" )
localify.Bind( "es-es", prefix.."label_max_offsetx",        "Desplazamiento X máximo" )
localify.Bind( "es-es", prefix.."label_max_offsety",        "Desplazamiento Y máximo" )
localify.Bind( "es-es", prefix.."label_max_offsetz",        "Desplazamiento Z máximo" )
localify.Bind( "es-es", prefix.."label_delay",              "Demora" )
localify.Bind( "es-es", prefix.."label_opacity",            "Opacidad" )
-- Checkboxes
localify.Bind( "es-es", prefix.."checkbox_freeze",          "Congelar props apilados" )
localify.Bind( "es-es", prefix.."checkbox_weld",            "Puntales apilados soldados" )
localify.Bind( "es-es", prefix.."checkbox_nocollide",       "Puntales apilados No-Collide entre sí" )
localify.Bind( "es-es", prefix.."checkbox_nocollide_all",   "Props apilados No-Collide con TODO" )
localify.Bind( "es-es", prefix.."checkbox_use_shift_key",   "Cambiar el tamaño de la pila con MAYÚS + clic izquierdo/derecho" )
localify.Bind( "es-es", prefix.."checkbox_relative",        "Pila relativa a la nueva rotación" )
localify.Bind( "es-es", prefix.."checkbox_material",        "Aplicar material" )
localify.Bind( "es-es", prefix.."checkbox_color",           "Aplicar color" )
localify.Bind( "es-es", prefix.."checkbox_physprop",        "Aplicar propiedades físicas" )
localify.Bind( "es-es", prefix.."checkbox_ghost",           "Ghostear todos los props en la pila" )
localify.Bind( "es-es", prefix.."checkbox_halo",            "Agregue halos a props ghosteados" )
localify.Bind( "es-es", prefix.."checkbox_halo_color",      "Color de Aureola" )
localify.Bind( "es-es", prefix.."checkbox_axis",            "Dibujar eje XYZ" )
localify.Bind( "es-es", prefix.."checkbox_axis_labels",     "Dibujar etiquetas de eje XYZ" )
localify.Bind( "es-es", prefix.."checkbox_axis_angles",     "Dibujar ángulos del eje XYZ" )
localify.Bind( "es-es", prefix.."checkbox_stayinworld",     "Permanecer en el mundo" )
-- Comboboxes
localify.Bind( "es-es", prefix.."combobox_world",           "Mundo" )
localify.Bind( "es-es", prefix.."combobox_prop",            "Prop" )
localify.Bind( "es-es", prefix.."combobox_direction_up",    "Arriba" )
localify.Bind( "es-es", prefix.."combobox_direction_down",  "Abajo" )
localify.Bind( "es-es", prefix.."combobox_direction_front", "Defrente" )
localify.Bind( "es-es", prefix.."combobox_direction_back",  "Atrás" )
localify.Bind( "es-es", prefix.."combobox_direction_right", "Derecha" )
localify.Bind( "es-es", prefix.."combobox_direction_left",  "Izquierda" )
localify.Bind( "es-es", prefix.."combobox_default",         "Defecto" )
localify.Bind( "es-es", prefix.."combobox_sandbox",         "Sandbox" )
localify.Bind( "es-es", prefix.."combobox_darkrp",          "DarkRP" )
localify.Bind( "es-es", prefix.."combobox_singleplayer",    "SinglePlayer" )
-- HUD
localify.Bind( "es-es", prefix.."hud_front",                "Defrente" )
localify.Bind( "es-es", prefix.."hud_right",                "Derecha" )
localify.Bind( "es-es", prefix.."hud_up",                   "Arriba" )
-- Help
localify.Bind( "es-es", prefix.."help_max_per_player",      "Máximo de props apilados a los que cada jugador está limitado." )
localify.Bind( "es-es", prefix.."help_max_per_stack",       "Máximo de props por pila (clic izquierdo)." )
localify.Bind( "es-es", prefix.."help_delay",               "Retraso (en segundos) entre cada uso del stacker (clic izquierdo/derecho)" )
localify.Bind( "es-es", prefix.."help_max_offsetx",         "Distancia máxima entre props apilados (eje X)." )
localify.Bind( "es-es", prefix.."help_max_offsety",         "Distancia máxima entre props apilados (eje Y)." )
localify.Bind( "es-es", prefix.."help_max_offsetz",         "Distancia máxima entre props apilados (eje Z)." )
localify.Bind( "es-es", prefix.."help_freeze",              "Los props apilados se congelan cuando se generan." )
localify.Bind( "es-es", prefix.."help_weld",                "Los props apilados se sueldan entre sí cuando se generan." )
localify.Bind( "es-es", prefix.."help_nocollide",           "Los props apilados no chocarán con otros props apilados." )
localify.Bind( "es-es", prefix.."help_nocollide_all",       "Los props apilados no chocarán con nada excepto con jugadores, NPC, vehículos y el mundo." )
localify.Bind( "es-es", prefix.."help_stayinworld",         "Evita que se creen props apilados fuera del mapa." )
-- Warnings
localify.Bind( "es-es", prefix.."warning_max_per_player",   "Principalmente para los modos de juego Roleplay. Para los modos de juego Sandbox, esto generalmente debería ser ilimitado (-1)." )
localify.Bind( "es-es", prefix.."warning_max_offsetx",      "Principalmente para los modos de juego Roleplay. No modifique a menos que sepa lo que está haciendo." )
localify.Bind( "es-es", prefix.."warning_max_offsety",      "Principalmente para los modos de juego Roleplay. No modifique a menos que sepa lo que está haciendo." )
localify.Bind( "es-es", prefix.."warning_max_offsetz",      "Principalmente para los modos de juego Roleplay. No modifique a menos que sepa lo que está haciendo." )
localify.Bind( "es-es", prefix.."warning_freeze",           "Para DarkRP." )
localify.Bind( "es-es", prefix.."warning_weld",             "Para DarkRP." )
localify.Bind( "es-es", prefix.."warning_nocollide",        "Para DarkRP." )
localify.Bind( "es-es", prefix.."warning_nocollide_all",    "NO CAMBIAR MIENTRAS EL SERVIDOR ESTÁ FUNCIONANDO. Esto usa el gancho GM.ShouldCollide y es experimental. Funciona y está garantizado que detendrá los bloqueos de Stacker, pero necesita más pruebas." )
